...
extension UITextField
{
    ...
    func setLeftSpace(viewWidth : Int , viewHeight : Int)
    {
        let outerView = UIView(frame: CGRect(x: CGFloat(0), y: CGFloat(0), width: CGFloat(viewWidth), height: CGFloat(viewHeight)))
        outerView.backgroundColor = UIColor.clear
