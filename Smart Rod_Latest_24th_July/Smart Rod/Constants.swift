...
{
    static let spacingViewWidth : Int = 16
    static let spacingViewHeight : Int = 40
    
    static let placedHolderTextFieldColor : UIColor = UIColor(red: 49/255, green: 49/255, blue: 49/255, alpha: 1)
    static let wellInfoPlaceHolderTextFieldColor : UIColor = UIColor.lightGray
    ...
    static let tableCornerRadiusValue : CGFloat = 10.0
    ...
    static let popUpViewFirstColor : UIColor = UIColor(red: 246/255, green: 217/255, blue: 88/255, alpha: 1)

    static let popUpViewSecondColor : UIColor = UIColor(red: 255/255, green: 191/255, blue: 41/255, alpha: 1)
    ...
    static func wellInfoPalceHolderColor(placeHolderText : String) ->NSAttributedString
    {
        return NSAttributedString(string:placeHolderText, attributes: [NSForegroundColorAttributeName: Constants.wellInfoPlaceHolderTextFieldColor])
    }
